...
![2.1](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_2_1.png)

*Рис. 2.1 — Расположение основных областей интерфейса программы*

### Панель настроек

![2.2](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_2_2.png)
...
![2.3](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_2_3.png)
...
![2.4](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_2_4.png)
...
![2.5](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_2_5.png)
...
![3.1](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_1.png)

*Рис. 3.1 — Выбор пункта “1. Сгенерировать и кластеризовать данные”

2. В окне "Генерация данных" выберите "1. Генерация распределений"

![3.2](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_2.png)

*Рис. 3.2 — Выбор типа генерации*

3. Задайте количество точек для генерации. В качестве примера на рис. 3.3 задается 100 точек.

![3.3](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_3.png)
...
![3.4](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_4.png)

*Рис. 3.4 — Указание размерности данных*

5. Для удобства мы уменьшим размеры окна и отделим окно “Генерация данных” (рис. 3.5).

![3.5](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_5.png)
...
![3.6](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_6.png)

*Рис. 3.6 — Настройка параметров распределения*

![3.7](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_7.png)

*Рис. 3.7 — Продолжение настройки*

![3.8](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_8.png)
...
![3.9](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_9.png)
...
![3.10](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_10.png)
...
![3.11](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_11.png)
...
![3.12](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_12.png)
...
![3.13](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_13.png)

*Рис. 3.13 — Демонстрация скрытых параметров*

![3.14](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_14.png)
...
![3.16](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_16.png)

*Рис. 3.16 — Кнопка "перестроить подокна"

![3.17](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_17.png)
...
![3.18](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_18.png)

*Рис. 3.18 – Отделения 2D-модели откластеризованных данных*

![3.19](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_19.png)

*Рис. 3.19 – Отделения 3D-модели откластеризованных данных*

![3.20](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_3_20.png)
...
![4.1](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_4_1.png)

*Рис. 4.1 — Выбор генерации данных*

2. В панели "Генерация данных" выберите "2. Генерация изображений" (рис. 4.2)

![4.2](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_4_2.png)
...
![4.3](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_4_3.png)
...
![4.4](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_4_4.png)

*Рис. 4.4 — Результаты генерации данных с помощью make-функций*

![4.5](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_4_5.png)
...
![4.6](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_4_6.png)

*Рис. 4.6 — Выделение второй строки (записи)*

![4.7](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_4_7.png)

*Рис. 4.7 — Удаление записи*

![4.8](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_4_8.png)
...
![4.9](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_4_9.png)
...
![4.10](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_4_10.png)
...
![4.11](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_4_11.png)

*Рис. 4.11 – Изменяемые и неизменяемые параметры функций*

![4.12](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_4_12.png)
...
![5.1](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_5_1.png)

*Рис. 5.1 – Выбор загрузки данных*

2. Нажмите "Выбрать" (рис. 5.2) и выберите изображение (рис. 5.3)

![5.2](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_5_2.png)
...
![5.3](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_5_3.png)

*Рис. 5.3 — Загрузка изображения*

![5.4](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_5_4.png)

*Рис. 5.4 — Кнопка "Открыть" для использвания изображения в программе*

3. Установите параметры кластеризации (рис. 5.5)

![5.5](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_5_5.png)

*Рис. 5.5 — Установка параметров кластеризации изображения*

![5.6](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_5_6.png)

*Рис. 5.6 — Выбора типа конвертации изображения*

![5.7](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_5_7.png)

*Рис. 5.7 — Результаты кластеризации изображения*

![5.8](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_5_8.png)
...
![6.1](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_6_1.png)

*Рис. 6.1 — Вход в реестр* на ОС windows

![6.2](https://github.com/SkyW0rd/DMM_ClusteringSystem/blob/docs-update/Programming_documentation/docs_images/uses_cases_6_2.png)
