"""
Тестовый скрипт для проверки CURE с визуализацией
...
def test_basic_2d_clustering():
    ...
    config = StrategiesManager.getStrategyRunConfigById("cure")
    config["n_clusters"] = 3
    config["number_represent_points"] = 5
    strategy = ConcreteStrategyCURE()
