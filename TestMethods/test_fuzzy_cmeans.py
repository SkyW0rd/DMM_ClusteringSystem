"""
Тестовый скрипт для проверки Fuzzy C-Means с визуализацией
...
def test_basic_2d_clustering():
    ...
    config = StrategiesManager.getStrategyRunConfigById("fuzzy_cmeans")
    config["n_clusters"] = 3
    config["m"] = 2.0
    strategy = ConcreteStrategyFCM()
