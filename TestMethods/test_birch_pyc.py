"""
Тестовый скрипт для проверки BIRCH (PyClustering) с визуализацией
...
ALGORITHM_NAME = "BIRCH_PyClustering"
...
def test_basic_2d_clustering():
    ...
    config = StrategiesManager.getStrategyRunConfigById("birch_pyc")
    config["n_clusters"] = 3
    strategy = ConcreteStrategyBIRCH_from_PYCLUSTERING()
