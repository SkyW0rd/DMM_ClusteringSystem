"""
Тестовый скрипт для проверки BallTree Clustering с визуализацией

Авторы: Кирьянов Даниил danyavolskiy@gmail.com и Ахмерова Анастасия anastasia.akhmerova.03@mail.ru
...
def test_basic_2d_clustering():
    ...
    config = StrategiesManager.getStrategyRunConfigById("balltree")
    config["n_clusters"] = 3
    config["linkage_method"] = "ward"
    config["metric"] = "euclidean"

    strategy = ConcreteStrategyBallTree()
